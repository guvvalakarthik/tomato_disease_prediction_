...
The Vercel API uses the tracked legacy model exported to ONNX so the serverless
function stays below Vercel's bundle limit. This is a compatibility deployment,
not a validated model release:
